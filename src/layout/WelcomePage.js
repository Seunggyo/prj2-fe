    ...
    >
      ...
      <div className="container max-w-6xl mx-auto mt-10">
        ...
        <div className="flex justify-center">
          <div class="max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4">
            ...
            <div class="pt-6 text-center">
              <p class="text-4xl font-dongle font-bold mb-1">김 승 교</p>
              <p class="text-gray-500">노 예 대 장</p>
            </div>
          </div>
          <div class="max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4">
            <div class="relative overflow-hidden px-6">
            ...
            <div class="pt-6 text-center">
              <p class="text-4xl font-dongle font-bold mb-1">김 다 솜</p>
              <p class="text-gray-500">실 세</p>
            </div>
          </div>
