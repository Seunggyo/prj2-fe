...
export function SideBar() {
    ...
    return (
        <Box>
            <div
                className="fixed flex flex-col top-24 left-0 w-14 hover:w-64 md:w-64 bg-white h-full text-gray-600 transition-all duration-300 border-none z-10 sidebar">
                                    ...
                                    <Menu>
                                        ...
                                        <MenuList>
                                            ...
                                            <MenuItem>
                                                {" "}
                                                <button
                                                    onClick={() => navigate("/hospital/reservationCheck?" + urlParams)}
                                                    className="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                                                    {" "}
                                                    예약 내역
                                                </button>
