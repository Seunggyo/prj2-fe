                ...
                <div className="mt-8 mb-2 mx-auto w-80 max-w-screen-xl sm:w-96">
                    ...
                    <div className="inline-flex items-center">
                        ...
                        >
                            ...
                            />
                            <span
                                className="pointer-events-none absolute top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 text-white opacity-0 transition-opacity peer-checked:opacity-100"></span>
                        </label>
                        <label
